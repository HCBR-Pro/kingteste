...
cr = 'KING-BOTZ\n'   //TIDAK PERLU DI UBAH
vr = 'KING-BOTZ'   //TIDAK PERLU DI UBAH
...
// Api
const namabot = 'KING-BOT' // Terserah lu mau ubah atau tidak.... 
       ...
       if (budy.includes(`@08xxxxxx`)) { 
		...
		if (budy.includes(`Bot`)) {
			...
			if (isGroup && !isCmd && isSimi && budy != undefined) {
						...
						console.log(color('KING-BOTZ','yellow'), ('Command Tidak Ditemukan!!','yellow'), color(sender.split('@')[0]))
					}
					}
		} catch (e) {
			console.log('Error : %s', color(e, 'red'))
